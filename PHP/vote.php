...
<body>
	...
	<section id="vote">
		<div class="row votelist">
			<div class="col-md block">
				<p class="big-col">Vote link 1 (PlanetMinecraft)</p>
				<div class="big-col-text">
					<img src="https://via.placeholder.com/166x166"> <br /><br />
					<a class="button" href="#">Vote here</a>
				</div>
			</div>
			<div class="col-md block">
				<p class="big-col">Vote link 1 (ServerPact)</p>
				<div class="big-col-text">
					<img src="https://via.placeholder.com/166x166"> <br /><br />
					<a class="button" href="#">Vote here</a>
				</div>
			...
			<div class="col-md block">
				<p class="big-col">Vote link 1 (Minecraft-MP)</p>
				<div class="big-col-text">
					<img src="https://via.placeholder.com/166x166"> <br /><br />
					<a class="button" href="#">Vote here</a>
				</div>
			...
			<div class="col-md block">
				<p class="big-col">Vote link 1 (MC Server List)</p>
				<div class="big-col-text">
					<img src="https://via.placeholder.com/166x166"> <br /><br />
					<a class="button" href="#">Vote here</a>
				</div>
	...
	<section id="rewards">
		<h2>Rewards when voting</h2>
		<hr>
		<p>Add your list here<br /> Example:</p>
		<p>- 32x Diamonds<br />- $500/$2500<br />- 32x Cooked Beef<br />- 64x Wood Logs<br />- 4x Random Item</p>
	</section>
