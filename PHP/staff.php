...
<body>
	...
	<!-- Header (Banner) -->
	<header id="head-staff" class="parallax">
		<h1><?php echo "$staff_title";  ?></h1>
	...
	<section id="staff">
		<div class="row stafflist">
			<div class="col-md">
				...
				<div class="big-col-text">
					<img style="width: 100%" width="333" src="https://minotar.net/avatar/Steve/1024"><br /><br />
					<p><b>Playername</b><br /><i>Owner</i></p>
				</div>
			</div>
			<div class="col-md">
				<p class="big-col">&nbsp;</p>
				<div class="big-col-text">
					<img style="width: 100%" width="333" src="https://minotar.net/avatar/Steve/1024"><br /><br />
					<p><b>Playername</b><br /><i>Co-Owner</i></p>
				</div>
			</div>
		</div><br>
		<div class="row stafflist">
			<div class="col-md">
				<p class="big-col">&nbsp;</p>
				<div class="big-col-text">
					<img style="width: 100%" width="222" src="https://minotar.net/avatar/Steve/1024"><br /><br />
					<p><b>Playername</b><br /><i>Admin</i></p>
				</div>
			</div>
			<div class="col-md">
				<p class="big-col">&nbsp;</p>
		...
		<div class="row stafflist">
			<div class="col-md">
				<p class="big-col">&nbsp;</p>
				<div class="big-col-text">
					<img style="width: 100%" width="111" src="https://minotar.net/avatar/Steve/1024"><br /><br />
					<p><b>Playername</b><br /><i>Moderator</i></p>
				</div>
			</div>
			<div class="col-md">
				<p class="big-col">&nbsp;</p>
			...
			<div class="col-md">
				...
				<div class="big-col-text">
					<img style="width: 100%" width="111" src="https://minotar.net/avatar/Steve/1024"><br /><br />
					<p><b>Playername</b><br /><i>Helper</i></p>
				</div>
			</div>
			<div class="col-md">
				<p class="big-col">&nbsp;</p>
